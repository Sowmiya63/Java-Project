...
public class GUI extends JFrame
{
	...
	public String c1,Mobile_v,Mobiless,messages;
	public int xpos1=0,ypos1=0,Mobilenumber=0;	
	public JMenu process,features,alg;
	public JMenuItem start,draw,refresh,redraw,chooser,exit,move,history,help;
	...
	public int sourceMobile,destinationMobile,moveMobile,temp,totalMobiles;
	String message;
	static JLabel lbl;
	Global global;
	JButton button,dis;
	String numberofMobiles;
	JSpinner js;
...
//	  	"Choose Network Here","INFRASTRUT","MobileCENTRIC","SENSOR","ADHOC"
//	};  
	public static String dataTypeOptions[] = {
	  	"Choose Network Here","ADHOC"
	}; 
	...
	{
		jmb.setBorder(BorderFactory.createLineBorder(Color.black,2));
	...
	public static void desktop(JDesktopPane jdp,Color color)
	{
		...
		jdp.setLayout(null);
	    jdp.setToolTipText("Location to Plot the Mobiles");
